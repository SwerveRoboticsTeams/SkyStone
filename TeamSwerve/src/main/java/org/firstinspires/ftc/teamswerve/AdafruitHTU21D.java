...
/*
 * Created by Cole Welch, modified from Adafruit MCP9808 temperature sensor class by Dryw Wade
 *
 * Driver for Adafruit's HTU21D(F) temperature and humidity sensor
 *
...
@I2cSensor(name = "HTU21D-F Temperature and Humidity Sensor", description = "Temperature and Humidity Sensor from Adafruit", xmlTag = "HTU21D-F")
public class AdafruitHTU21D extends I2cDeviceSynchDevice<I2cDeviceSynch>
{
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // User Methods
    ////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    ...
    public enum Register
    {
        FIRST(0x01),
        CONFIGURATION(0x01),
        MANUFACTURER_ID(0x02),
        TRIGGER_TEMPERATURE_MEASUREMENT_HOLD_MASTER(0x03),
        TRIGGER_HUMIDITY_MEASUREMENT_HOLD_MASTER(0x04),
        TRIGGER_TEMPERATURE_MEASUREMENT_NO_HOLD_MASTER(0x05),
        TRIGGER_HUMIDITY_MEASUREMENT_NO_HOLD_MASTER(0x06),
        WRITE_USER_REGISTER(0x07),
        READ_USER_REGISTER(0x08),
        SOFT_RESET(0x09),
    ...
    {
        return "Adafruit HTU21D-F Temperature & Humidity Sensor";
    }
}
